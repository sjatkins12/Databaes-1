...
urlpatterns = [
    ...
    url(r'^category/subcategory/(?P<subcategory_name>([\w]+)\s?)+/$', views.subcategory, name='subcategory'),
    # Page that displays the discussion for the given interest group
    url(r'^category/subcategory/interest_group/(?P<interest_group_name>([\w]+)\s?)+/$',
